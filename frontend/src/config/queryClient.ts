...
export const queryKeys = {
  ...
  species: {
    ...
    list: (filters?: Record<string, unknown>) => [...queryKeys.species.lists(), filters] as const,
  ...
  cms: {
    all: ['cms'] as const,
    birds: (params?: Record<string, unknown>) => [...queryKeys.cms.all, 'birds', params] as const,
    bird: (id: number) => [...queryKeys.cms.all, 'bird', id] as const,
    birdByName: (name: string) => [...queryKeys.cms.all, 'bird', 'name', name] as const,
    lessons: (params?: Record<string, unknown>) => [...queryKeys.cms.all, 'lessons', params] as const,
